...
;!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        link: function (t, i, n) {
            if (r.path) {
                ...
                s.rel = "stylesheet", s.href = r.path + t, s.id = f, document.getElementById(f) || a.appendChild(s), "function" == typeof i && !function u() {
                    return ++c > 80 ? e.console && console.error("orgTree.css: Invalid") : void (1989 === parseInt(o.getStyle(document.getElementById(f), "width")) ? i() : setTimeout(u, 100))
                }()
            }
        }
    }, r = {
        v: "3.1.1", ie: function () {
            ...
            var t = "layer", i = "", n = (a ? "modules/layer/" : "") + "default/orgTree.css?v=" + r.v + i;
...
!function (N, A) {
    ...
    return function (N) {
        ...
        N.exports = {
            isSupported: U, parse: r, patchDict: I, genToken: e, convertToPinyin: function (N, A, t) {
